...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String [] PUBLIC_MATCHERS = {"h2-console/**", "/principal"};
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, PUBLIC_MATCHERS_GET).permitAll().anyRequest()
		.authenticated().and().formLogin().defaultSuccessUrl(INDEX_PATH_STRING).permitAll().and().logout()
